    ...
    return (
      ...
      >
        <div className="relative w-80 h-64">
          {testimonials.map((testimonial, index) => {
            ...
            return (
              <motion.div
                key={testimonial.id}
                className={cn(
                  "absolute w-[30rem] h-[16rem] rounded-2xl cursor-grab active:cursor-grabbing",
                  "bg-[#618371] shadow-xl",
              ...
              >
                {showArrows && isCurrentCard && (
                  <div className="absolute inset-x-0 top-2 flex justify-between px-4">
                    <span className="text-2xl select-none cursor-pointer text-green-950 hover:text-gray-400  dark:hover:text-primary">
                      &larr;
                    </span>
                    <span className="text-2xl select-none cursor-pointer text-green-950 hover:text-gray-400 dark:hover:text-primary">
                      &rarr;
                ...
                <div className="p-6 flex flex-col items-center gap-4">
                  ...
                  <p className="text-center text-sm text-green-950 dark:text-muted-foreground">
          ...
          {showDots && (
            <div className="absolute -bottom-8 left-[10rem] right-0 flex justify-center gap-2">
