    ...
    return (
        <>
            ...
            <nav className="fixed top-0 left-0 w-full flex items-center justify-between px-6 md:px-12 py-4 z-50 ">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-white tracking-wide"></h1>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed top-0 left-0 w-full h-full bg-black text-white flex items-center justify-between px-20 py-12 z-40"
                    >
