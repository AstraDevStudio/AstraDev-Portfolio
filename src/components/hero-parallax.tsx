...
export const HeroParallax = ({
  ...
  return (
    ...
    <div
      ref={ref}
      className="min-h-[300vh]  hidden py-1 overflow-hidden antialiased relative md:flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product md:h-96 md:w-[30rem] h-56 w-[20rem] relative flex-shrink-0 "
    >
      <a
        href={product.link}
